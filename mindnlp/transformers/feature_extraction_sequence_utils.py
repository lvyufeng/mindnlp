...
from mindnlp.utils import PaddingStrategy, TensorType, is_mindspore_tensor, logging, to_numpy
...
class SequenceFeatureExtractor(FeatureExtractionMixin):
    ...
    def pad(
        ...
        If the `processed_features` passed are dictionary of numpy arrays, MindSpore tensors or TensorFlow tensors, the
        ...
        # If we have MindSpore/TF tensors or lists as inputs, we cast them as Numpy arrays
