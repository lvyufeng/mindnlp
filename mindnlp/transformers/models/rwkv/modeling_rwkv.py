...
class RwkvSelfAttention(nn.Module):
    ...
    def __init__(self, config, layer_id=0):
        ...
        self.key = nn.Dense(hidden_size, attention_hidden_size, bias=False)
        self.value = nn.Dense(hidden_size, attention_hidden_size, bias=False)
        self.receptance = nn.Dense(hidden_size, attention_hidden_size, bias=False)
        self.output = nn.Dense(attention_hidden_size, hidden_size, bias=False)
...
class RwkvFeedForward(nn.Module):
    ...
    def __init__(self, config, layer_id=0):
        ...
        self.key = nn.Dense(hidden_size, intermediate_size, bias=False)
        self.receptance = nn.Dense(hidden_size, hidden_size, bias=False)
        self.value = nn.Dense(intermediate_size, hidden_size, bias=False)
...
class RwkvForCausalLM(RwkvPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.head = nn.Dense(config.hidden_size, config.vocab_size, bias=False)
