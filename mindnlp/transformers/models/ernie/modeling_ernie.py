...
class ErnieEmbeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        Args:
            ...
            config: An object containing configuration parameters for the ErnieEmbeddings class. The config object should have the following attributes:
...
class ErnieSelfAttention(nn.Module):
    ...
    The class inherits from nn.Module and includes methods for initializing the self-attention mechanism, transposing tensors for scoring calculations, and constructing the attention mechanism outputs.
    """
    def __init__(self, config, position_embedding_type=None):
        ...
        Raises:
            ValueError: If the hidden size is not a multiple of the number of attention heads and the config does not have an 'embedding_size' attribute.
        """
        super().__init__()
...
Defaults to None.
            ...
            past_key_value (Optional[Tuple[Tuple[mindspore.Tensor]]]): The cached key-value pairs from previous attention computations. Defaults to None.
...
class ErnieSelfOutput(nn.Module):
    ...
    """
    The ErnieSelfOutput class represents a module for self-attention mechanism in ERNIE (Enhanced Representation through kNowledge Integration) model. 
    This class inherits from nn.Module and contains methods to apply dense, layer normalization, and dropout operations to the input tensor.
...
class ErnieAttention(nn.Module):
    ...
    ''' 
    This class represents the ErnieAttention module, which is a part of the ERNIE (Enhanced Representation through kNowledge Integration) model. 
    The ErnieAttention module is used for self-attention mechanism and output processing. It includes methods for head pruning and attention construction. 
    This class inherits from nn.Module and is designed to be used within the ERNIE model architecture for natural language processing tasks.
    '''
    def __init__(self, config, position_embedding_type=None):
        """
    ...
    def prune_heads(self, heads):
        ...
        Returns:
            None: This method does not return any value. It operates by modifying the attributes of the ErnieAttention instance in-place.
    ...
    def forward(
        ...
        Args:
            ...
            attention_mask (Optional[mindspore.Tensor]): An optional mask tensor for the attention scores. Defaults to None.
            head_mask (Optional[mindspore.Tensor]): An optional mask tensor for controlling the attention heads. Defaults to None.
            encoder_hidden_states (Optional[mindspore.Tensor]): An optional tensor containing the hidden states of the encoder. Defaults to None.
            encoder_attention_mask (Optional[mindspore.Tensor]): An optional mask tensor for the encoder attention scores. Defaults to None.
...
class ErnieIntermediate(nn.Module):
    ...
    This class inherits from nn.Module and contains methods for initialization and constructing the intermediate layer.
    ...
    Methods:
        __init__(self, config): Initializes the ERNIE intermediate layer with the provided configuration.
...
class ErnieOutput(nn.Module):
    ...
    This class inherits from the nn.Module class and includes methods for initializing and constructing the output layer for the model.
    
    The __init__ method initializes the ErnieOutput instance with the specified configuration. It initializes the dense layer, LayerNorm, and dropout for processing the output.
    
    The construct method processes the hidden states and input tensor to generate the final output tensor using the initialized dense layer, dropout, and LayerNorm.
...
class ErnieLayer(nn.Module):
    ...
    """ErnieLayer is a class representing a layer in the Ernie model. This class inherits from nn.Module and contains methods for initializing the layer and constructing the layer's feed forward chunk.
    ...
    Methods:
        __init__(config): Initializes the ErnieLayer with the provided configuration.
        construct(hidden_states, attention_mask, head_mask, encoder_hidden_states, encoder_attention_mask, past_key_value, output_attentions): Constructs the layer using the given input tensors and parameters.
    ...
    def __init__(self, config):
        ...
        Args:
            ...
            config: A configuration object containing various settings for the ErnieLayer.
                Type: object
    ...
    def forward(
        ...
        Args:
            ...
            encoder_attention_mask (Optional[mindspore.Tensor]): Mask for the encoder attention mechanism. Defaults to None.
            past_key_value (Optional[Tuple[Tuple[mindspore.Tensor]]]): Cached key and value tensors for fast inference. Defaults to None.
        ...
        Raises:
            ValueError: If `encoder_hidden_states` are passed, and cross-attention layers are not instantiated by setting `config.add_cross_attention=True`.
        """
    ...
    def feed_forward_chunk(self, attention_output):
        ...
        Args:
            ...
            attention_output (object): The attention output from the previous layer, expected to be a tensor representing the attention scores.
        
        Returns:
            None: This method does not return any value explicitly but updates the layer_output attribute of the ErnieLayer instance.
...
class ErnieEncoder(nn.Module):
    ...
    Methods:
        __init__(self, config): Initializes the ErnieEncoder with the provided configuration.
    ...
    Notes:
        - The construct method supports various optional input parameters and returns different types of outputs based on the provided arguments.
    ...
    def __init__(self, config):
        ...
        Args:
            ...
            config (dict): A dictionary containing configuration parameters for the ErnieEncoder. It should include the following keys:
    ...
    def forward(
        ...
        Args:
            ...
            encoder_attention_mask (Optional[mindspore.Tensor]): The attention mask tensor for the encoder. Defaults to None.
...
class ErniePooler(nn.Module):
    ...
    This class inherits from nn.Module and implements a pooler layer that takes hidden states as input, processes the first token tensor through a dense layer and activation function, and returns the pooled
output.
    ...
    Methods:
        __init__(self, config): Initializes the ErniePooler object with the provided configuration.
    ...
    def __init__(self, config):
        ...
        Args:
            self: The instance of the class.
            config: An object of type 'config' which contains the configuration parameters.
...
input hidden states.
    ...
    Methods:
        __init__(self, config): Initializes the class instance with the provided configuration.
        construct(self, hidden_states: mindspore.Tensor) -> mindspore.Tensor: Applies the transformation operations on the input hidden states and returns the transformed states.
...
class ErnieLMPredictionHead(nn.Module):
    ...
    This class inherits from nn.Module and provides methods for initializing the prediction head and constructing predictions based on the input hidden states. 
    ...
    Methods:
        - __init__(self, config): Initializes the prediction head with the given configuration.
        - construct(self, hidden_states): Constructs predictions based on the input hidden states by applying transformation and decoding operations.
    ...
    def __init__(self, config):
        ...
        Args:
            ...
            config: An object that holds configuration settings for the ErnieLMPredictionHead. 
                    It is expected to contain properties like hidden_size, vocab_size, and any other relevant configuration parameters.
    ...
    def forward(self, hidden_states):
        ...
        Args:
            self: Represents the instance of the class. It is implicitly passed and does not need to be provided as an argument.
            
            hidden_states (Tensor): The input hidden states to be processed. It is expected to be a tensor containing the initial hidden states.
...
class ErnieOnlyMLMHead(nn.Module):
    ...
    """
    This class represents the implementation of the ErnieOnlyMLMHead, which is used for masked language model (MLM) prediction in Ernie language model. 
    It inherits from the nn.Module class and contains methods for initializing the class and constructing MLM predictions based on the input sequence output.
    """
    def __init__(self, config):
        """
    ...
    def forward(self, sequence_output: mindspore.Tensor) -> mindspore.Tensor:
        ...
        Returns:
            mindspore.Tensor: The prediction scores generated by the MLM head.
                The prediction scores represent the likelihood of each token being masked and need to be compared with the
                corresponding ground truth labels during the training process.
...
class ErnieOnlyNSPHead(nn.Module):
    ...
    Methods:
    - __init__(self, config): Initializes the NSP head with a Dense layer for sequence relationship prediction.
    - construct(self, pooled_output): Constructs the NSP score by passing the pooled output through the Dense layer.
    ...
    def forward(self, pooled_output):
        ...
        Args:
            ...
            pooled_output: Tensor containing the pooled output from the model.
                Type: Tensor
                Purpose: Represents the output features obtained after pooling.
                Restrictions: Must be a valid tensor object.
        
        Returns:
            seq_relationship_score: The calculated sequence relationship score based on the pooled output.
                Type: None
...
class ErniePreTrainingHeads(nn.Module):
    ...
    """
    The ErniePreTrainingHeads class represents the pre-training heads for ERNIE model, used for predicting masked tokens and sequence relationships. It inherits from nn.Module and provides methods for
initializing the prediction heads and making predictions.
    ...
    - construct(self, sequence_output, pooled_output): Constructs the pre-training heads using the sequence output and pooled output, and returns the prediction scores and sequence relationship score.
...
class ErnieModel(ErniePreTrainedModel):
    ...
    def get_input_embeddings(self):
        ...
        Returns:
            None. The method returns the input embeddings for the ErnieModel.
    ...
    def set_input_embeddings(self, value):
        ...
        Args:
            ...
            value: The input embeddings to be set for the ErnieModel. It should be of type that is compatible with the embeddings.word_embeddings attribute.
...
and access specific logits from the model.
    ...
    def get_output_embeddings(self):
        ...
        Returns:
            None: This method does not return anything but directly accesses and returns the output embeddings from the model.
...
class ErnieForCausalLM(ErniePreTrainedModel):
    ...
    """
    This class represents a causal language modeling model based on the ERNIE (Enhanced Representation through kNowledge Integration) architecture. 
...
mask, past key values, and use_cache flag.
    ...
    def set_output_embeddings(self, new_embeddings):
        ...
        Args:
            self (ErnieForCausalLM): The instance of the ErnieForCausalLM class.
            new_embeddings: The new embeddings to be set as output embeddings. It should be of the same shape as the existing embeddings.
...
output_hidden_states, return_dict): Constructs the model for training or inference, computing the masked language modeling loss and prediction scores.
    ...
    def __init__(self, config):
        ...
        Description:
            ...
            This method also logs a warning if the 'is_decoder' flag in the 'config' parameter is set to True, indicating that the model is being used as a decoder.
    ...
    def get_output_embeddings(self):
        ...
        Returns:
            None. This method returns the output embeddings stored in the 'decoder' of the 'predictions' object within the ErnieForMaskedLM model.
...
next sequence prediction loss if labels are provided.
    ...
    The method returns a tuple of the next sentence prediction loss, the next sentence relationship scores, and other optional outputs such as hidden states and attentions.
