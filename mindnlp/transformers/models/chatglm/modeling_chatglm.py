...
positional information.
    ...
    def attention_mask_func(attention_scores, attention_mask):
        ...
        Args:
            attention_scores (tensor): The attention scores to which the mask will be applied. The tensor should be of type float32 and have the shape (batch_size, num_heads, sequence_length, sequence_length). 
            attention_mask (tensor): The attention mask that will be used to mask the attention_scores. The tensor should be of type bool and have the shape (batch_size, 1, 1, sequence_length).
...
hidden states through self-attention and MLP layers.
    ...
    Note: This docstring is generated based on the provided code and does not include actual code or signatures.
    """
    def __init__(
            self,
            hidden_size,
...
sample, processing model responses, and facilitating chat interactions. It also provides methods for streaming chat and generation.
    ...
    def forward(
        ...
        Args:
            ...
            return_dict (Optional[bool]): Whether to return a dictionary or not. If not provided, defaults to the value specified in the model's configuration.
...
the method.
    ...
    def stream_chat(self, tokenizer, query: str, history: List[Tuple[str, str]] = None, max_length: int = 2048,
        ...
        Args:
            ...
            history (List[Tuple[str, str]], optional): A list of tuples containing the previous queries and their responses. Defaults to None.
            max_length (int, optional): The maximum length of the generated response. Defaults to 2048.
            ...
            logits_processor (object, optional): An object used for processing logits during response generation. Defaults to None.
