...
SPEECH_TO_TEXT_INPUTS_DOCSTRING = r"""
    Args:
        input_features (`mindspore.Tensor` of shape `(batch_size, sequence_length, feature_size)`):
            ...
            tensor of type `mindspore.Tensor`. See [`~Speech2TextFeatureExtractor.__call__`]
...
class Speech2TextForConditionalGeneration(Speech2TextPreTrainedModel):
    ...
    def __init__(self, config: Speech2TextConfig):
        ...
        self.lm_head = nn.Dense(config.d_model, self.config.vocab_size, bias=False)
