...
from ....utils import TensorType, is_mindspore_available, is_mindspore_tensor, is_vision_available, logging
...
class MobileViTImageProcessor(BaseImageProcessor):
        ...
        **kwargs,
        ...
        if segmentation_maps is not None:
            segmentation_maps = make_list_of_images(
                segmentation_maps, expected_ndims=2)
    ...
    def post_process_semantic_segmentation(self, outputs, target_sizes: List[Tuple] = None):
        """
        Converts the output of [`MobileViTForSemanticSegmentation`] into semantic segmentation maps. Only supports MindSpore.
