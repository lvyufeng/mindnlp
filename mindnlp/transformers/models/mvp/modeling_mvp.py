...
class MvpAttention(nn.Module):
    ...
    def forward(
        ...
        attn_prompt: Optional[mindspore.Tensor] = None,
...
class MvpEncoderLayer(nn.Module):
    ...
    def forward(
        ...
        self_attn_prompt: mindspore.Tensor,
...
class MvpDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        self_attn_prompt: Optional[mindspore.Tensor] = None,
        cross_attn_prompt: Optional[mindspore.Tensor] = None,
        past_key_value: Optional[Tuple[mindspore.Tensor]] = None,
        output_attentions: Optional[bool] = False,
...
class MvpEncoder(MvpPreTrainedModel):
    ...
    def forward(
        ...
        # layer-wise prompt
        if self.use_prompt:
            prompt_ids = ops.arange(self.prompt_length)
