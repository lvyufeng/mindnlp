...
SPEECH_ENCODER_DECODER_INPUTS_DOCSTRING = r"""
    Args:
        inputs (`mindspore.Tensor` of shape `(batch_size, sequence_length)` or `(batch_size, sequence_length, feature_dim)`, *optional*):
        ...
        decoder_attention_mask (`torch.BoolTensor` of shape `(batch_size, target_sequence_length)`, *optional*):
            ...
            be used by default.
        encoder_outputs (`tuple(mindspore.Tensor)`, *optional*):
        ...
        output_hidden_states (`bool`, *optional*):
            ...
            more detail.
        input_values (`mindspore.Tensor` of shape `(batch_size, sequence_length)`, *optional*):
            Float values of input raw speech waveform. Values can be obtained by loading a *.flac* or *.wav* audio file
            into an array of type *List[float]* or a *numpy.ndarray*, *e.g.* via the soundfile library (*pip install
            soundfile*). To prepare the array into *input_values*, the [`Wav2Vec2Processor`] should be used for padding
            and conversion into a tensor of type *mindspore.Tensor*. See [`Wav2Vec2Processor.__call__`] for details.
        input_features (`mindspore.Tensor` of shape `(batch_size, sequence_length, feature_size)`, *optional*):
            ...
            into a tensor of type `mindspore.Tensor`. See [`~Speech2TextFeatureExtractor.__call__`]
