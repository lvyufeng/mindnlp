    ...
    def convert_to_tensors(
        ...
        if tensor_type == TensorType.MINDSPORE:
            if not is_mindspore_available():
                raise ImportError("Unable to convert output to MindSpore tensors format, MinSpore is not installed.")
...
name 'raise_exception'. This allows the template to raise an error by calling the 'raise_exception' function with an error message as an argument.
        ...
        try:
            ...
            raise ImportError("apply_chat_template requires jinja2 to be installed.") from exc
    ...
    def batch_encode_plus(
        ...
        **kwargs,
        ...
        Args:
            batch_text_or_text_pairs (`List[str]`, `List[Tuple[str, str]]`, `List[List[str]]`, `List[Tuple[List[str], List[str]]]`, and for not-fast tokenizers,
    ...
    def batch_decode(
        self,
        sequences: Union[List[int], List[List[int]], "np.ndarray", "mindspore.Tensor"],
        ...
        **kwargs,
        ...
        Args:
            sequences (`Union[List[int], List[List[int]], np.ndarray, mindspore.Tensor, tf.Tensor]`):
    ...
    def decode(
        ...
        **kwargs,
        ...
        Args:
            token_ids (`Union[int, List[int], np.ndarray, mindspore.Tensor, tf.Tensor]`):
                List of tokenized input ids. Can be obtained using the `__call__` method.
            skip_special_tokens (`bool`, *optional*, defaults to `False`):
                Whether or not to remove special tokens in the decoding.
            clean_up_tokenization_spaces (`bool`, *optional*):
